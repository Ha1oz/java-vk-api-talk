...
@Service
public class MessageSendResponseToVKService {
    private static final Logger LOG = LoggerFactory.getLogger(MessageSendResponseToVKService.class);

    @Value("${vk.auth.token}")
    private String authToken;
    private final String url = "https://api.vk.com/method/messages.send";

    public void sendToVK(MessageSendModel model) {
